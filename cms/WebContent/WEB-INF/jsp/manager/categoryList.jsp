		...
		<tbody>
			...
			<c:forEach items="${categoryList}" var="category">
				<tr>
					...
					<td class="pl5"><span class="fontLv"> ${category.code }</span></td>
					<td class="pl5"><span class="ico_edit" val="${category.id }"></span>
						<span class="ico_del ml5" val="${category.id }"></span></td>
				</tr>
			</c:forEach>
