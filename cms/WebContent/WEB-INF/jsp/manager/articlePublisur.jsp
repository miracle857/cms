	...
	<div class="c_editview">
		<div class="c_r_right_border">
			<div class="website_base">
				<form action="manager/articlePublisur.do" method="post">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<tr>
									...
									<td class="pl5"><select name="categoryId">
								...
								<tr>
									<td colspan="2"><textarea name="content"
											class="website_edit" cols="100"></textarea></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="btn_left btn_left_bcol">
						<button class="btn_gray mr5 ml5" type="submit">发布</button>
					</div>
				</form>
			</div>
		</div>
